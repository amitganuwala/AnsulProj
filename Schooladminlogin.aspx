<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Schooladminlogin.aspx.cs" Inherits="login" %>
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login"  runat="server">
		        ...
		        <div class="login-wrap">
		            <asp:TextBox runat="server" ID="txtname" class="form-control" AutoPostBack="true" placeholder="Username" autofocus></asp:TextBox>
		            <br>
