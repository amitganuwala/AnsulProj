...
public partial class login : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand objcmd = new SqlCommand("spplogin", objcon);
        ...
        {
            Session["Parent_name"] = txtname.Text;

            FormsAuthentication.RedirectFromLoginPage(txtname.Text, check.Checked);

            //create a cookie
            HttpCookie myCookiep = new HttpCookie("myCookiep");

            //Add key-values in the cookie
            myCookiep["pnm"] = txtname.Text;

            //set cookie expiry date-time. Made it to last for next 12 hours.
            myCookiep.Expires = DateTime.Now.AddMonths(3);

            //Most important, write the cookie to client.
            Response.Cookies.Add(myCookiep);

            string sql3 = "SELECT [name], [school] FROM [parent] WHERE ([usr] = '"+ txtname .Text+ "')";
            ...
            Response.Redirect("~/Parent/Default.aspx");
