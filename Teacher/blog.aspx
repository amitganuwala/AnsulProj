<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/Site.master" AutoEventWireup="true" CodeFile="blog.aspx.cs" Inherits="pr_blog" %>
					...
					<div class="box">
						...
						<div class="wrap-vid">
							<div class="zoom-container">
                                ...
                                <div class="col-lg-4">
							    <p><%# Eval("dscr") %> <asp:HyperLink runat="server" ID="Hyp" NavigateUrl='<%# Eval("id","~/Teacher/single.aspx?id={0}") %>'>MORE....</asp:HyperLink></p></div>
                                </div>
