<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/Site.master" AutoEventWireup="true" CodeFile="news.aspx.cs" Inherits="pr_news" %>
				...
				<div class="col-md-6">
                 <asp:DataList class="list" ID="rptitem" runat="server"  RepeatLayout="flow" RepeatDirection="Vertical" >
					...
					<div class="box wrap-vid">
						...
						<p class="more"><%# Eval("dscr") %>  <asp:HyperLink runat="server" ID="Hyp" NavigateUrl='<%# Eval("id","~/Teacher/Copy of singlein.aspx?id={0}") %>'>MORE....</asp:HyperLink></p>
					</div>
