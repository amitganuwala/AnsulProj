<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Parentlogin.aspx.cs" Inherits="login" %>
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login"  runat="server">
		        ...
		        <div class="login-wrap">
		            <asp:TextBox runat="server" ID="txtname" AutoPostBack="true" class="form-control" placeholder="Username" autofocus></asp:TextBox>
		            <br>
		            ...
		            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [name], [school] FROM [parent] WHERE ([usr] = @usr)">
                        <SelectParameters>
