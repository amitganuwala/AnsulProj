<%@ Page Title="" Language="C#" MasterPageFile="~/Parent/MasterPage.master" AutoEventWireup="true" CodeFile="view-timetable.aspx.cs" Inherits="Teacher_view_timetable" %>
          	...
          	<div class="row mt">
          			...
          			<div class="form-panel">
                          ...
                          <asp:Label runat="server" ID="lblstdnm" Visible="false" ></asp:Label>
                            ...
                            <h2><asp:Label runat="server" ID="lblsch" Text="school" ForeColor="Black" Visible="false"></asp:Label></h2>
                         
                       <asp:GridView ID="GridView1" class="table table-striped table-advance table-hover table-responsive" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" AllowSorting="True" ShowHeader="False">
                           <Columns>
                          ...
                          <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                              ...
                              SelectCommand="SELECT * FROM [timetable] WHERE (([class] = @class) AND ([school] = @school)) ORDER BY [id] DESC">
                              <SelectParameters>
