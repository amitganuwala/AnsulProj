<%@ Page Title="" Language="C#" MasterPageFile="~/School/Site.master" AutoEventWireup="true" CodeFile="gal.aspx.cs" Inherits="Teacher_gal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <section id="main-content">
          ...
          <ItemTemplate>
          <asp:HyperLink runat="server" ID="Hyp" NavigateUrl='<%# Eval("id","~/School/zoom.aspx?id={0}") %>'>
