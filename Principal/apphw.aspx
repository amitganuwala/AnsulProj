<%@ Page Title="" Language="C#" MasterPageFile="~/Principal/Site.master" AutoEventWireup="true" CodeFile="apphw.aspx.cs" Inherits="Principal_apphw" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:TableRow>
       ...
       <asp:TableCell><asp:Label runat="server" ID="lblid"></asp:Label></asp:TableCell>
                                ...
                                </asp:table></section></div></div></div></form></div></div></div>
