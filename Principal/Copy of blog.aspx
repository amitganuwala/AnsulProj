<%@ Page Title="" Language="C#" MasterPageFile="~/Principal/Site.master" AutoEventWireup="true" CodeFile="Copy of blog.aspx.cs" Inherits="pr_blog" %>
                 ...
                 <asp:DataList class="list" ID="rptitem" runat="server"  RepeatLayout="flow" RepeatDirection="Vertical" >
					...
					<div class="box">
						...
						<div class="wrap-vid">
							...
							<p><%# Eval("dscr") %> <asp:HyperLink runat="server" ID="Hyp" NavigateUrl='<%# Eval("id","~/Principal/singlein.aspx?id={0}") %>'>MORE....</asp:HyperLink>
						</div>
					</div>
