<%@ Page Title="" Language="C#" MasterPageFile="~/Principal/Site.master" AutoEventWireup="true" CodeFile="blog.aspx.cs" Inherits="pr_blog" %>
...
<div id="page-content" class="archive-page container">
		<div class="row">
        <div class="col-lg-3"><asp:TextBox ID="txtschnm" runat="server" CssClass="form-control" placeholder="Search by school name"></asp:TextBox></div>
        <div class="col-lg-3"><asp:TextBox ID="txtsubj" runat="server" CssClass="form-control" placeholder="Search by subject"></asp:TextBox></div>
        <div class="col-lg-3"><asp:TextBox ID="txtaddnm" runat="server" CssClass="form-control" placeholder="Search by person name who added blog"></asp:TextBox></div>
        <div class="col-lg-3"><asp:Button ID="btn" runat="server" CssClass="btn btn-theme02" Text="Search" OnClick="btn_Click" /></div>
        </div><br /><br />
			<div class="row">
				<div class="col-md-8">
					...
					<div class="box">
						...
						<div class="wrap-vid">
							<div class="zoom-container">
                                ...
                                <div class="row">
                                <div class="col-lg-4">
                                <asp:Image ID="img" runat="server" ImageUrl='<%# Eval("pic","../Teacher/img/{0}") %>' Height="170px" Width="250px" /></div>
                                <div class="col-lg-4">
							    <p><%# Eval("dscr") %> <asp:HyperLink runat="server" ID="Hyp" NavigateUrl='<%# Eval("id","~/Principal/single.aspx?id={0}") %>'>MORE....</asp:HyperLink></p></div>
                                </div>
                 ...
                 <asp:DataList class="list" ID="grdvw" runat="server"  RepeatLayout="flow" RepeatDirection="Vertical" >
                        <ItemTemplate>
					...
					<div class="box">
						...
						<div class="wrap-vid">
							...
							<p><%# Eval("dscr") %> <asp:HyperLink runat="server" ID="Hyp" NavigateUrl='<%# Eval("id","~/Principal/single.aspx?id={0}") %>'>MORE....</asp:HyperLink>
						</div>
					</div>
                    </ItemTemplate></asp:DataList>
	</div>
     <div class="col-md-4">
          ...
          <%--
            <asp:DataList class="list" ID="DataList1" runat="server"  RepeatLayout="flow" RepeatDirection="Vertical" >
                        <ItemTemplate>
					...
					<div class="box">
						...
						<div class="wrap-vid">
							<div class="zoom-container">
                               ...
                               <asp:Image ID="img" runat="server" ImageUrl='<%# Eval("pic","../Teacher/img/{0}") %>' Height="80px" Width="150px" />
                               </div>
                                <p><%# Eval("dscr") %> <asp:HyperLink runat="server" ID="Hyp" NavigateUrl='<%# Eval("id","~/Principal/single.aspx?id={0}") %>'>MORE....</asp:HyperLink></p>
                                </div>
