<%@ Page Title="" Language="C#" MasterPageFile="~/Principal/Site.master" AutoEventWireup="true" CodeFile="news.aspx.cs" Inherits="pr_news" %>
				...
				<div class="col-md-6">
                 <asp:DataList class="list" ID="rptitem" runat="server"  RepeatLayout="flow" RepeatDirection="Vertical" >
                    ...
                    <asp:Image ID="img" runat="server" ImageUrl='<%# Eval("pic","../Teacher/img/{0}") %>' />
						...
						<p class="more"><%# Eval("dscr") %>  <asp:HyperLink runat="server" ID="Hyp" NavigateUrl='<%# Eval("id","~/Principal/Copy of singlein.aspx?id={0}") %>'>MORE....</asp:HyperLink></p>
					</div>
