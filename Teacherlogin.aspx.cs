...
public partial class login : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand objcmd = new SqlCommand("sptlogin", objcon);
        ...
        {
            Session["Teacher_name"] = txtname.Text;

            FormsAuthentication.RedirectFromLoginPage(txtname.Text, check.Checked);
     
       //create a cookie
       HttpCookie myCookiet = new HttpCookie("myCookiet");

       //Add key-values in the cookie
       myCookiet["tnm"] = txtname.Text;

       //set cookie expiry date-time. Made it to last for next 12 hours.
       myCookiet.Expires = DateTime.Now.AddMonths(3);
